const createNav = () => {
  ...
  nav.innerHTML = `<nav class="vavbar">
        <div class="top_nav">
          <p>
          ...
          <div class="links_with_icons">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <div class="header_container">
                  <div class="header">
                    <h2><a href="stationary.html"> All Stationary</a></h2>
                  </div>
                  <div class="header">
      ...
      <div class="navbar2">
        <nav class="vavbar2">
          ...
          <div class="nav">
            <div class="nav_logo">
              <a href="index.html"><img src="./img/Poketo-Logo-Site.png" alt="" /></a>
            </div>
            <div class="links_with_icons">
              <div class="nav_icons">
                <div>
                ...
                <div class="dropdown2">
                  ...
                  <div class="dropdown2-content">
                    <div class="header2_container">
                      ...
                      <div class="header2">
                        <h2><a href="stationary.html">Stationery</a></h2>
                      </div>
                      <div class="header2">
